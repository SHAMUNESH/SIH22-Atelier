...
def respond(voice_data):
    ...
    if 'who are you' in voice_data:
        alexis_speak('I am your atelier voice assistant! You can call me with my name.')
    if 'what is your name' in voice_data:
        alexis_speak('My name is Iris!')
    ...
    # SIH AI Assistance scripts!

      
    if 'latest customer review' in voice_data:
        alexis_speak('Your latest customer, Amit is very happy of your work! He says the product looks amazing and well packed.')

    if 'need support' in voice_data:
        alexis_speak('what problem are you facing?')

    if 'login issue' in voice_data:
        alexis_speak('we have sent u a video demo! Please check')

time.sleep(1)
alexis_speak('Hello there, i am your atelier AI assistance!')
while 1:
